...
TrajectoryType smoothTrajectoryWithKalman(const TrajectoryType &trajectory, double processNoise, double measurementNoise)
{
...
*/
    ...
    TrajectoryType sTrajectory = smoothTrajectoryWithKalman(trajectory, 0.01, 0.1);
...
void StraydotRemove(TrajectoryType &data, vector<int> &num, int init)
{
...
// 找出拐点的函数
TrajectoryType findforkPoints(TrajectoryType &trajectory, double epsilon, int changeThreshold)
{
